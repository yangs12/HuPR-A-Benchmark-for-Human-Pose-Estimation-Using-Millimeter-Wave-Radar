...
df = pd.DataFrame(file_exists, columns=['File Name', 'Shape'])

# Save the DataFrame to an Excel file
df.to_excel('/home/HuPR-A-Benchmark-for-Human-Pose-Estimation-Using-Millimeter-Wave-Radar/shape_errors.xlsx', index=False)